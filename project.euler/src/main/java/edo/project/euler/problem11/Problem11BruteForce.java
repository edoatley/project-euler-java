...
public class Problem11BruteForce {
	public static int[][] GRID= { {  8,  2, 22, 97, 38, 15,  0, 40,  0, 75,  4,  5,  7, 78, 52, 12, 50, 77, 91,  8 }
	...
	public int solve() {
		int maxHorizontal = getLargestHorizontal();
		int maxVertical = getLargestVertical();
		int maxDiagonal = getLargestDiagonal();
		
		return Math.max(maxDiagonal, Math.max(maxHorizontal, maxVertical));
	}
